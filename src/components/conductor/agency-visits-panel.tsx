...
export function AgencyVisitsPanel({ driverId }: { driverId: string }) {
  ...
  return <Panel title="Visitas de agencias" action={<><Building2 className="h-5 w-5 text-emerald-300" /><CompactInfoDisclosure ariaLabel="Información de visitas de agencias">Solo movimientos físicos. Los cobros y saldos permanecen en contabilidad.</CompactInfoDisclosure></>}>
