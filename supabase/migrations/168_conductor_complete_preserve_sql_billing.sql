-- L-H3: never replace logistics_plan with a client preview after SQL payment authority.
-- Milestone/status keys remain patchable; billing / lastDriverCollection are SQL-owned.
